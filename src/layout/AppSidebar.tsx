...
const navItems: NavItem[] = [
  ...
  //   path: "",
  //   subItems: [
  //     { name: "Country", path: "/system/country" },
  //     { name: "State", path: "/system/state" },
  //     { name: "Role", path: "/system/role" },
  //     { name: "User", path: "/system/user" },
  //     { name: "Center Info", path: "/system/centerInfo" },
  //     { name: "Re-test Criteria", path: "/system/retest" },
  //     { name: "Settings", path: "/system/setting" },
  //   ],
  // },
  // {
...
const AppSidebar: React.FC = () => {
  ...
  (["main"] as const).forEach((menuType) => {
    ...
    >
      ...
      >
        <Link href="/">
          {isExpanded || isHovered || isMobileOpen ? (
            <Image
              src="/images/logo/checkinlogo.png"
              alt="Logo"
              width={150}
              height={150}
            />
